...
video3 = 'AgACAgIAAxkBAAL-umJmtP94NDq1QJ5VeS4Cx8WvGPJ-AAIaujEbOYY5S_RsjER2bSxEAQADAgADcwADJAQ' #ЗАМЕНИЛИ НА ФОТО 3
    ...
    if int(cheak_black(call.message.chat.id)) == 0:
        ...
        if call.data == 'bat_video3': #отправляем второе видео
            ...
            if bat_video3 == 1:
                ...
                await bot.send_photo(chat_id=call.message.chat.id,photo=video3,caption="""❗️Как пройти обучение, результативно - <a href = 'https://youtu.be/1I3ABl_GX4A'>СМОТРЕТЬ</a>👈необходимо нажать
...
❗️Как пользоваться ботом❗️""",reply_markup=markup)
        ...
        if call.data == 'battun1':
            ...
            if time1 == 1:
                ...
                bat_b = types.InlineKeyboardButton(text='Для чего нужен опрос', url= 'https://youtube.com/shorts/bJVnQMmdcLo')
...
Смотри видео👇""")
        ...
        if call.data == 'battun7':
            ...
            if time7 == 1:
                markup = types.InlineKeyboardMarkup()
                bat_a = types.InlineKeyboardButton(text='🍿ВИДЕО🍿', url='https://youtu.be/3mCHIsH0Zz8')
...
<a href = 'https://t.me/+XQUxhMT3xwJjZDFi'>👉ЭРО КОНТЕНТ ТУТ👈(НАЖМИ)</a></b>""")
        ...
        if call.data == 'battun18':
            ...
            if time18 == 1:
                markup = types.InlineKeyboardMarkup()
                bat_a = types.InlineKeyboardButton(text='🍿ВИДЕО🍿', url='https://youtu.be/LoKF_FnSFPc')
